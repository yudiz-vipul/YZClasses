...
//MARK: - Protocol YZTextViewdDelegate
/// It is used to get `UITextView` events.
@objc public protocol YZTextViewdDelegate: class {
    @objc optional func textViewDidChange(_ tableCell: YZParentTVC, anyObject: Any?)
}
